...
RESET = 0	# reset counter -> after finding IR beacon, moves forward til 1000, stop to 1050, back to 1250 and continue
    ...
    while not rospy.is_shutdown():
      ...
      if IR_FLAG:
        ...
        # === IR signal is found, go straight === #
          ...
          RESET += 1
	  if RESET <= 1000:	#go straight
            pub.publish(1)
          elif RESET <= 1050:	#stop
            pub.publish(0)
          elif RESET <= 1250:
            pub.publish(2)
          else:
